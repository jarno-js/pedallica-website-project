...
@section('content')
    <div class="max-w-7xl mx-auto px-6 py-12">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-10">
            <!-- Pedallica A -->
            <a href="{{ route('fotos-ploegen.show', 'pedallica-a') }}" class="relative group rounded-2xl overflow-hidden shadow-lg hover:scale-105 transition-transform duration-300 cursor-pointer">
            ...
            <!-- Pedallica B -->
            <a href="{{ route('fotos-ploegen.show', 'pedallica-b') }}" class="relative group rounded-2xl overflow-hidden shadow-lg hover:scale-105 transition-transform duration-300 cursor-pointer">
                <div class="h-56 bg-gray-300 bg-center bg-cover flex items-center justify-center"
            ...
            <!-- Pedallica C -->
            <a href="{{ route('fotos-ploegen.show', 'pedallica-c') }}" class="relative group rounded-2xl overflow-hidden shadow-lg hover:scale-105 transition-transform duration-300 cursor-pointer">
                <div class="h-56 bg-gray-300 bg-center bg-cover flex items-center justify-center"
        ...
        <div class="flex flex-wrap justify-center gap-8">
            <!-- MTB -->
            <a href="{{ route('fotos-ploegen.show', 'mtb') }}" class="w-full sm:w-[350px] lg:w-[380px] relative group rounded-2xl overflow-hidden shadow-lg hover:scale-105 transition-transform duration-300 cursor-pointer">
                <div class="h-56 bg-gray-300 bg-center bg-cover flex items-center justify-center"
            ...
            <!-- Pedallicava -->
            <a href="{{ route('fotos-ploegen.show', 'pedallicava') }}" class="w-full sm:w-[350px] lg:w-[380px] relative group rounded-2xl overflow-hidden shadow-lg hover:scale-105 transition-transform duration-300 cursor-pointer">
                <div class="h-56 bg-gray-300 bg-center bg-cover flex items-center justify-center"
